...
import './styles/simple-menu.css'; // Простое и надежное бургерное меню
    ...
    <header className={`main-header ${isScrolled ? 'scrolled' : ''}`} ref={headerRef}>
      <nav>
        ...
        <div className="main-header-right">
          ...
          <button 
            className={`simple-burger ${isMobileMenuOpen ? 'active' : ''}`}
      ...
      <div className={`simple-mobile-menu ${isMobileMenuOpen ? 'open' : ''}`}>
        <Link to="/" onClick={() => setIsMobileMenuOpen(false)} className="mobile-link">
          <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="mobile-icon">
        ...
        <Link to="/prices" onClick={() => setIsMobileMenuOpen(false)} className="mobile-link">
          <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="mobile-icon">
        ...
        <Link to="/reviews" onClick={() => setIsMobileMenuOpen(false)} className="mobile-link">
          <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="mobile-icon">
        ...
        <Link to="/faq" onClick={() => setIsMobileMenuOpen(false)} className="mobile-link">
          <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="mobile-icon">
        ...
        {!user ? (
          <>
            <Link to="/login" onClick={() => setIsMobileMenuOpen(false)} className="mobile-link">
              <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="mobile-icon">
            ...
            <Link to="/register" onClick={() => setIsMobileMenuOpen(false)} className="mobile-link">
              <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="mobile-icon">
          ...
          <Link to="/dashboard" onClick={() => setIsMobileMenuOpen(false)} className="mobile-link">
            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="mobile-icon">
      ...
      {isMobileMenuOpen && <div className="simple-overlay" onClick={toggleMobileMenu}></div>}
    </header>
  );
}
