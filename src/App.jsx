...
function Header() {
  ...
  const handleTouchMove = (e) => {
    if (!touchStartX.current || !isMenuOpen) return;
    
    const currentX = e.touches[0].clientX;
    const diff = touchStartX.current - currentX;
    
    if (diff > 0) return; // Игнорируем свайп влево
    ...
    <header className={`main-header ${isScrolled ? 'scrolled' : ''}`}>
      <nav className="header-nav">
        ...
        >
          ...
          <Link to="/prices" onClick={closeMenu} className="nav-link">
            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="nav-icon">
          ...
          <Link to="/reviews" onClick={closeMenu} className="nav-link">
            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="nav-icon">
          ...
          <Link to="/faq" onClick={closeMenu} className="nav-link">
            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="nav-icon">
              ...
              <path d="M11.5 10.5C10.7091 11 12.5 9.20914 12.5 7C12.5 4.79086 10.7091 3 8.5 3C6.29086 3 4.5 4.79086 4.5 7C4.5 9.20914 6.29086 11 8.5 11Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
